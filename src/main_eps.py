...
def main(cfg: DictConfig) -> None:
    ...
    epsilon_list = cfg.setting.epsilon_list
    ...
    for eps in epsilon_list:
        ...
        result_df.to_csv("eps.csv")

        plot(vary_list=epsilon_list, result_df=result_df, variable_name="eps")
        plot_normalize(vary_list=epsilon_list, result_df=result_df, variable_name="eps")
        tqdm.write("=====" * 15)
