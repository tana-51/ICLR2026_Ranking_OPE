...
def main(cfg: DictConfig) -> None:
    ...
    for effect_from_ranking in effect_from_ranking_list:
        if cfg.setting.reward_type_conversion == "continuous":
            dataset = SyntheticSlateBanditDataset(
                ...
                effect_from_ranking=effect_from_ranking,
            )
        else: #binary
            dataset = SyntheticSlateBanditDataset(
                n_unique_action=cfg.setting.n_unique_action,
        ...
        result_df["effect_from_ranking"] = effect_from_ranking
    ...
    plot_normalize(vary_list=effect_from_ranking_list, result_df=result_df, variable_name="effect_from_ranking", pi_e_value=np.abs(pi_e_value))
