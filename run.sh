...
#len_list
# python ./src/main_len_list.py setting.run_file="main_len_list" setting.reward_type_conversion="continuous" setting.len_list=5 setting.evaluation_policy_logit="linear_behavior_policy_logit"


# python ./src/main_num_data.py setting.run_file="num_data_test" setting.reward_type_conversion="continuous" setting.len_list=5 setting.evaluation_policy_logit="linear_behavior_policy_logit"
